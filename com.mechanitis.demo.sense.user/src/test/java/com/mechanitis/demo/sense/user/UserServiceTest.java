...
class UserServiceTest {
    private static final String EXAMPLE_TWEET = "tweet = {\"created_at\":\"Tue Jan 27 12:37:11 +0000 2015\"," +
    ...
    @Test
    void shouldExtractTwitterHandleFromTweet() {
        // when
        String handle = UserService.getTwitterHandleFromTweet(EXAMPLE_TWEET);

        // then
        assertEquals("trisha_gee", handle);
    }
}